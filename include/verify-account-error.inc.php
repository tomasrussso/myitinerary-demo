<?php RegisterLog('Error:Verify account', true); ?>
<!DOCTYPE html>
<html lang="pt">
<head>
    <meta charset="UTF-8">
        ...
        <div class="container">
            <div class="row justify-content-center title">
                <div class="col-auto text-center">
                    <h1>Parece que algo correu mal...</h1>
                    <p style="margin-top: 12px; font-size: 1.1rem">É provável que o link fornecido já não esteja válido, ou que já tenha validado a sua conta.</p>
                </div>
            </div>
        </div>
    </div>
